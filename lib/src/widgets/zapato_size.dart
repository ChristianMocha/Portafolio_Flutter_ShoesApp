    ...
    return GestureDetector(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
          ...
          vertical: (this.fullScreen) ? 5 : 0, // si es pantalla completa, no hay padding vertical
        ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius:  (!this.fullScreen) ? BorderRadius.circular(50):const BorderRadius.only(
